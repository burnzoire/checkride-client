...
describe("KillEventQueue", () => {
  ...
  describe("resolveWeapon (client-authoritative attribution)", () => {
    it("merges the resolved weapon over the enrichment weapon at the rendezvous", async () => {
      ...
      expect(resolveWeapon).toHaveBeenCalledWith({ killerUcid: "killer-1", victimObjectId: 4242, weaponName: "AIM-120C", victimPositionX: null, victimPositionY: null });
    ...
    it("resolves a held kill on enrichment arrival, passing the enrichment victim object id", async () => {
      ...
      expect(resolveWeapon).toHaveBeenCalledWith({ killerUcid: "killer-1", victimObjectId: 77, weaponName: "AIM-120C", victimPositionX: null, victimPositionY: null });
